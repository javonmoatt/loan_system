                    ...
                    <div class="w-full p-6">
                        ...
                        <form action="{{ route('documents.update', $document->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{ documentFor: '{{ $document->loan_id ? 'loan' : 'customer' }}' }">
                            ...
                            <div>
                                ...
                                <input type="file" name="file" id="file" class="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none focus:border-blue-500">
                                @error('file')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
