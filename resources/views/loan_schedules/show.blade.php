                ...
                <div class="bg-black">
                    <div class="w-full">
                        <div class="bg-white p-6">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-gray-900">{{ number_format($loan->amount, 2) }} {{ strtoupper($loan->currency) }}</p>
                                        </div>
                                        <div>
                            ...
                            <!-- Loan Schedules -->
                            <div class="mt-8">
                                <h3 class="text-xl font-semibold mb-4">Loan Schedules</h3>
                                <div class="overflow-x-auto">
                                    <table class="min-w-full bg-white">
                                        <thead>
                                            <tr>
                                                <th class="py-2 px-4 border-b">Due Date</th>
                                                <th class="py-2 px-4 border-b">Amount Due</th>
                                                <th class="py-2 px-4 border-b">Principal Amount</th>
                                                <th class="py-2 px-4 border-b">Interest Amount</th>
                                        ...
                                        <tbody>
                                            @foreach ($loan->schedules as $schedule)
                                                <tr>
                                                    <td class="py-2 px-4 border-b">{{ $schedule->due_date }}</td>
                                                    <td class="py-2 px-4 border-b">{{ number_format($schedule->amount_due, 2) }}</td>
                                                    <td class="py-2 px-4 border-b">{{ number_format($schedule->principal_amount, 2) }}</td>
                                                    <td class="py-2 px-4 border-b">{{ number_format($schedule->interest_amount, 2) }}</td>
