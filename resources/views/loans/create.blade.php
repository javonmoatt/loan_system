            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Create Loan</span>
                    </div>
                </li>
            </ol>
        </nav>
                    ...
                    <div class="w-full">
                        <div class="bg-white p-6">
                            ...
                            <div class="flex justify-between items-center mb-6">
                                <h2 class="text-2xl font-bold">Create New Loan</h2>
                            ...
                            <form action="{{ route('loans.store') }}" method="POST">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="penalty_rate" id="penalty_rate" value="{{ old('penalty_rate') }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               step="0.01">
                                        @error('penalty_rate')
                                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="number_of_installments" id="number_of_installments" value="{{ old('number_of_installments') }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               min="1">
                                    ...
                                    <div>
                                        ...
                                        <select name="repayment_frequency" id="repayment_frequency"
                                            ...
                                            <option value="fortnightly" {{ old('repayment_frequency') == 'fortnightly' ? 'selected' : '' }}>Fortnightly</option>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="term" id="term" value="{{ old('term') }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               min="1" required>
                                        @error('term')
                                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <select name="currency" id="currency"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                            <option value="jmd" {{ old('currency') == 'jmd' ? 'selected' : '' }}>JMD</option>
                                            <option value="cad" {{ old('currency') == 'cad' ? 'selected' : '' }}>CAD</option>
                                            <option value="usd" {{ old('currency') == 'usd' ? 'selected' : '' }}>USD</option>
                                            <option value="kyd" {{ old('currency') == 'kyd' ? 'selected' : '' }}>KYD</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="interest_calculation_method" id="interest_calculation_method"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                            <option value="fixed" {{ old('interest_calculation_method') == 'fixed' ? 'selected' : '' }}>Fixed</option>
                                            <option value="declining_balance" {{ old('interest_calculation_method') == 'declining_balance' ? 'selected' : '' }}>Declining Balance</option>
                                            <option value="declining_balance_equal_installment" {{ old('interest_calculation_method') == 'declining_balance_equal_installment' ? 'selected' : '' }}>Declining Balance (Equal Installment)</option>
                                        </select>
