            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit Payment: {{ $payment->id }}</span>
                    </div>
                </li>
            </ol>
        </nav>
                            ...
                            <form action="{{ route('payments.update', $payment->id) }}" method="POST">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="amount_due" id="amount_due" value="{{ old('amount_due', $payment->amount_due) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               step="0.01" required>
                                        @error('amount_due')
                                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="amount_paid" id="amount_paid" value="{{ old('amount_paid', $payment->amount_paid) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               step="0.01">
                                        @error('amount_paid')
                                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="due_date" id="due_date" value="{{ old('due_date', $payment->due_date->format('Y-m-d')) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               required>
                                        @error('due_date')
                                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="paid_date" id="paid_date" value="{{ old('paid_date', $payment->paid_date ? $payment->paid_date->format('Y-m-d') : '') }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                        @error('paid_date')
                                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
